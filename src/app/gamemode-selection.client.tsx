...
export default function GamemodeSelector({
  ...
  return (
    <button className="w-full h-[500px] outline-none xl:h-full group xl:max-h-[500px] flex flex-col max-w-[610px] items-center justify-start rounded-lg relative overflow-hidden">
      <Image
        src={image}
        alt={`${title}`}
      ...
      <div className="mt-auto bg-[#2C2828A8] z-20 bg-opacity-70 w-full h-fit py-8 flex flex-col items-center justify-center gap-6">
        ...
        {features.map((feature, index) => (
          ...
          >
            <p className="text-[20px] text-white tracking-text">{index + 1}.</p>
